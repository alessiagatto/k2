...
VALUES ('geekfactory@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Geek', 'Factory', 'Unisa, Dipartimento Informatica', '3476549862', '5436724598431234', 'GeekFactory', 476, 'admin');
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('mariorossi@gmail.com','$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Mario', 'Rossi', 'Caserta, Via Lazio 14', '3476549862', '5436724598431234', 'Mario Rossi', 476); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('luigiverdi@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Luigi', 'Verdi', 'Roma, Via Cesare 17', '3518457668', '6745982476311234', 'Luigi Verdi', 435); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('lorenzobianchi@gmail.com','$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Lorenzo', 'Bianchi', 'Messina, Via Federico Fellini 14', '3474351776', '8791267534971234', 'Lorenzo Bianchi', 143); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('gigiprossi@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Gigi Pio', 'Rossi', 'Caserta, Via Lazio 14', '3518234671', '7613872515281234', 'Gigi Pio Rossi', 621); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('davidesari@yahoo.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Davide', 'Sari', 'Palermo, Via Libertà 15', '3517628334', '8901034567391234', 'Davide Sari', 165); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('emildcarlo@libero.it', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Emiliano', 'De Carlo', 'Napoli, Via Superiore 24', '3479228888', '3241768501101234', 'Emiliano De Carlo', 823); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('saraverdi@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Sara', 'Verdi', 'Pisa, Via Miracoli 73', '3476629882', '6734891203451234', 'Sara Verdi', 820); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('federeale@yahoo.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Federica', 'Reale', 'Salerno, Via Ponzi 1', '3471192332', '8923674123781234', 'Federica Reale', 732); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('cr7@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Cristiano', 'Ronaldo', 'Torino, Via Gemma 34', '3519938471', '7639071056291234', 'Cristiano Ronaldo', 623); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('simonebianchi@yahoo.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Simone', 'Bianchi', 'Milano, Via Verità 83', '3479990110', '7823019820351234', 'Simone Bianchi', 999); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('miriamesp@libero.it', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Miriam', 'Esposito', 'Napoli, Via Positano 56', '3479928998', '7153918202031234', 'Miriam Esposito', 102); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('michver@yahoo.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Michele', 'Verdi', 'Pavia, Via Roma 11', '3519923000', '6172918291541234', 'Michele Verdi', 629); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('dantealig@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Dante', 'Alighieri', 'Firenze, Via Santa Margherita 1', '3518823999', '8178291004211234', 'Dante Alighieri', 555); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('alemanzoni@gmail.com', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Alessandro', 'Manzoni', 'Milano, Via Gerolamo Morone 1', '3512579112', '7182192004621234', 'Alessandro Manzoni', 172); 
INSERT INTO UserAccount (email, passwordUser, nome, cognome, indirizzo, telefono, numero, intestatario, CVV)
VALUES ('pessimismocosmico@libero.it', '$2a$10$E1N.KmH1xK5/Nt3qS9X/Ju4y89JX/OVBXp0IQiPvlK8q8A0/IkIli', 'Giacomo', 'Leopardi', 'Recanati, Via Leopardi 14', '3519928000', '1672819100321234', 'Giacomo Leopardi', 671);
